...
um = client.util.LoginFromClientSecrets(
    ...
    credentials='asker_cred.dat')

# Ask UM for the logged items
reslist = um.ask(context=["Apps", 'Logging'], view=['logged_items'])

# Go through the returned evidence and count the number of times each item
# was logged
d = defaultdict(int)
for res in reslist:
...
# get the length of the longest string in the keys of d. Don't try this at
# home.
