...
def _createResource(http, baseUrl, model, requestBuilder,
    ...
    def createMethod(theclass, methodName, methodDesc, rootDesc):
        ...
        def method(self, **kwargs):
            ...
            model = self._model
            # If there is no schema for the response then presume a binary
            # blob.
            ...
            if media_filename:
                ...
                if media_upload.resumable():
                    ...
                    # sent in the first request, otherwise an empty body is
                    # sent.
