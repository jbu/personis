...
class TestPersonis(unittest.TestCase):
    ...
    def test_simple(self):
        ...
        # an http object. We can add proxy or certificate validation here if
        # needed.
        ...
        resp, content = h.request(
            "https://s0.personis.name/ask", "POST", json.dumps(data))

        # receive the json response, and in this case check (it was a unit
        # test)
