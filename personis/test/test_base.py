...
class TestPersonisBase(unittest.TestCase):
    ...
    def test_make_del_age(self):
        cobj = base.Component(Identifier="age",
                              component_type="attribute",
                              Description="age",
                              goals=[['Personal',
                                      'Health',
    ...
    def test_export(self):
        ...
        self.assertEquals(
            modeljson['components']['firstname']['value'],
            'Alice')
    ...
    def test_resolver(self):
        def myresolver(
                model=None, component=None, context=None, resolver_args=None):
    ...
    def test_register_app(self):
        appdetails = self.um.registerapp(
            app="MyHealth",
            desc="My Health Manager",
            password="pass9")
        self.assertEqual(appdetails,
                         {u'realm': u'password',
                          u'password': u'c28cce9cbd2daf76f10eb54478bb0454',
                          u'givenpw': None,
                          u'description': u'My Health Manager'})
        ...
        # should work now.
        reslist = appum.ask(context=["test"], view='fullname')
        # mainly checking it doesn't throw an execption, but should really
