...
class Access:
    ...
    def __init__(self):
        self.evidencefilterlist = {
            "all": self._All_filter,
            "last1": self.last1_filter,
            "last10": self.last10_filter,
            "goal": self.goal_filter,
            "since_time": self.since_time_filter,
            "recent_count": self.recent_count_filter}
...
class Evidence_list:
    ...
    def __init__(self, elist=None, model=None, componentid=None):
        ...
        if model is not None:
            ...
            try:
                self.evdb, self.evdb_fd = shelf_open(
                    model.curcontext + "/.evidence", "r")
            except:
                raise ValueError(
    ...
    def __getitem__(self, index):
        ...
        elif isinstance(index, type(slice)):
